...
dispatch(removeFavorites(card.id)) : dispatch(addFavorites(card));
};
...
<MainCardContainer>
    ...
    <CardBody>
        ...
        <CardWrapper>
            ...
            <p>{location}</p><VerticalLine>|</VerticalLine>{''}
        ...
        <CardMain>
            ...
            <MainList>
                ...
                <li>
                    <InfoLine>Experience:</InfoLine>{experience}
                </li>
                <li>
                    <InfoLine>Kids age:</InfoLine>{kids_age}
                </li>
                <li>
                    <InfoLine>Characters:</InfoLine>{characters}
                </li>
                <li>
                    <InfoLine>Education:</InfoLine>{education}
                </li>
            </MainList>
            <p>
                {about}
