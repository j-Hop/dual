...
const handleSubmit = ({address, number, childAge, time, email, name, comment}, {resetForm})=>{
...
return(
<Formik
initialValues={{address:'', number:'', childAge:'', time:'', email:'', name:'', comment:'' }}
...
<label aria-label='Field for Child is age'>
    <CardStyleMini name='Child is age' type='number' placeholder='Child is age'/>
...
<label aria-label='Field for Father is or mother is name'>
    <CardStyledBig name='Father is or mother is name' type='text' placeholder='Father is or mother is name' />
    <ErrMsg component='div' name='Father is or mother is name'/>
</label>

<label aria-label='Field for comment'>
    <CardStyleComment name='comment' type='text' placeholder='Comment'/>
