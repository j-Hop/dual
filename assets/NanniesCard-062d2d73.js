import{s as i,t as n,F as L,j as e,e as W,g as c,h as Y,r as d,b as P,E as l,S as h,B as D,_ as S,i as U,d as V,u as Z,o as K,A as J,k as Q,l as ee,m as ne}from"./index-918fd177.js";const ie=i.div`
  display: flex;
  gap: ${n.spacing(10)};
...
`,ce=({isOpen:s,onRequestClose:r})=>e.jsxs(A,{isOpen:s,onRequestClose:r,children:[e.jsx("h2",{children:"Meeting time"}),e.jsx("p",{children:"9:00"}),e.jsx("p",{children:"9:30"}),e.jsx("p",{children:"10:00"}),e.jsx("p",{children:"10:30"})]}),de=W({address:c().min(3,"Must least 3 symbols").max(64,"At most 64 symbols").required("This ia a required field"),number:c().min(9,"Simple Format: XXX-XX-XX").max(9,"Simple Format: XXX-XX-XX").required("This is a required field").matches(/^\+?\d{1,4}?[-.\s]?\(?\d{1,3}?\)?[-.\s]?\d{1,4}[-.\s]?\d{1,4}[-.\s]?\d{1,9}$/,"Phone number must be digits and dashes."),childAge:Y().min(1,"Must be 1 number").max(2,"At most 2 number").required("This is a required field"),time:c().required("Chose one option"),email:c().email("Invalid email adress").required("This is a required field"),name:c().min(3,"Must be 3 symbols").max(32,"At most 32 symbols").required("This is a required field"),comment:c().min(4,"Must be 4 symbols").max(2e3,"At most 2000 symbols").required("This is a required field")}),he=({card:s,onRequestClose:r})=>{const[a,o]=d.useState(!1),t=({address:u,number:v,childAge:b,time:k,email:y,name:w,comment:C},{resetForm:j})=>{S.success("Successfully sent date",{position:"top-right",duration:5e3}),j(),r()},x=()=>{o(!0)},m=()=>{o(!1)};return e.jsx(P,{initialValues:{address:"",number:"",childAge:"",time:"",email:"",name:"",comment:""},onSubmit:t,validationSchema:de,children:e.jsxs(le,{children:[e.jsxs(ie,{children:[e.jsx("h3",{children:"Make an appointment with a babysitter"}),e.jsx("p",{children:"Arranging a meeting with a caregiver for your child is the first step to creating a safe and comfortable environment. Fill out the form below so we can match you with the perfect care partner."})]}),e.jsxs(re,{children:[e.jsx(se,{src:s.avatar_url,alt:"avatar",width:"44",height:"44"}),e.jsx("p",{children:"Your nanny"}),e.jsx("h3",{children:s.name})]}),e.jsxs(te,{children:[e.jsxs("label",{"aria-label":"Field for address",children:[e.jsx($,{name:"address",type:"text",placeholder:"Address"}),e.jsx(l,{name:"address",component:"div"})]}),e.jsxs("label",{"aria-label":"Field for Child is age",children:[e.jsx($,{name:"Child is age",type:"number",placeholder:"Child is age"}),e.jsx(l,{name:"Child is age",component:"div"})]}),e.jsxs("label",{"aria-label":"Field for number",children:[e.jsx($,{name:"number",type:"tel",placeholder:"+380"}),e.jsx(l,{name:"number",component:"div"})]}),e.jsxs("label",{"aria-label":"Field for time",children:[e.jsx($,{name:"time",type:"number",placeholder:"00:00"}),e.jsx(l,{name:"time",component:"div"}),e.jsx(oe,{onClick:x,type:"text",children:e.jsx("svg",{width:"20",height:"20",children:e.jsx("use",{xlinkHref:`${h}#icon-clock}`})})})]}),e.jsxs("label",{"aria-label":"Field for email",children:[e.jsx(M,{name:"email",type:"email",placeholder:"Email"}),e.jsx(l,{component:"div",name:"email"})]}),e.jsxs("label",{"aria-label":"Field for Father is or mother is name",children:[e.jsx(M,{name:"Father is or mother is name",type:"text",placeholder:"Father is or mother is name"}),e.jsx(l,{component:"div",name:"Father is or mother is name"})]}),e.jsxs("label",{"aria-label":"Field for comment",children:[e.jsx(ae,{name:"comment",type:"text",placeholder:"Comment"}),e.jsx(l,{component:"div",name:"comment"})]})]}),e.jsx(D,{type:"submit",children:e.jsx("span",{children:"Send"})}),e.jsx(ce,{id:"time",isOpen:a,onRequestClose:m,children:e.jsx(A,{onRequestClose:m})})]})})},pe=i.img`
